...
```bash
wget https://github.com/yeager/tp-lint/releases/download/v1.0.0/tp-lint_1.0.0_all.deb
...
```bash
wget https://github.com/yeager/tp-lint/releases/download/v1.0.0/tp-lint-1.0.0-1.noarch.rpm
sudo rpm -i tp-lint-1.0.0-1.noarch.rpm
```

### Arch Linux

```bash
wget https://github.com/yeager/tp-lint/releases/download/v1.0.0/tp-lint-1.0.0.pkg.tar.zst
sudo pacman -U tp-lint-1.0.0.pkg.tar.zst
```
